...
public class ExcelReport
{
    ...
    public static void generateExcel(Ini config) throws IOException
    {
        ...
        System.out.println("Writing to " + getFileName());
        wb.write(fileOut);
        fileOut.close();
    }
    ...
    public static String getFileName()
    {
        ...
        SimpleDateFormat fileFormat = new SimpleDateFormat("'scratch/NYSenate_Web_Analytics_'MMM_yyyy'.xls'");
        return fileFormat.format(cal.getTime());
    }
}
